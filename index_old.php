...
<head>
  ...
  <script type="text/javascript">
      ...
      <?php 
include('javascript_user_details.php');
?>
...
<style>
    #dock{
        left: 50%;   /*Berechnung: 50% - (WIDTH-PX/2)*/
        left: calc(50% - 78px);/*Bei Lehrer*/     
        left: calc(50% - 115px);/*Bei Schueler*/
    }
</style>
...
.desktop .deskIcon { position: relative;
  text-align: center;
  display: inline-block;
  padding: 12px 12px;
}
.desktop .deskIcon span { position: absolute;
  top: 84px;
  left: 13px;
...
.stundenPlan .body .left::-webkit-scrollbar, .stundenPlan .body .center::-webkit-scrollbar, #readMeInfoDiv > div.body::-webkit-scrollbar {
    width: 8px;
    height: 8px;
}

.stundenPlan .body .left.thin::-webkit-scrollbar, .stundenPlan .body .center.thin::-webkit-scrollbar{
    width: 2px;
}

.stundenPlan .body .left::-webkit-scrollbar-track, .stundenPlan .body .center::-webkit-scrollbar-track,
.stundenPlan .body .left::-webkit-scrollbar-track-piece, .stundenPlan .body .center::-webkit-scrollbar-track-piece,
 #readMeInfoDiv > div.body::-webkit-scrollbar-track, #readMeInfoDiv > div.body::-webkit-scrollbar-track-piece {
    border-radius: 10px;
    background: #eee;
}

.stundenPlan .body .left::-webkit-scrollbar-thumb, .stundenPlan .body .center::-webkit-scrollbar-thumb,
...
.stundenPlan .body .center { position: absolute;
  top: 0;
  padding-top: 38px;
  left: 22.5%;
  z-index: 80;
...
<div id="div1"></div>
        ...
        <nav id="menu-rechts">
            <ul>
                <li>
                    <a href="#" onclick="openAndCloseNotificationCenter()"><span id="notificationIcon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
                </li>
                <li>
                    <a href="#"><b><span id="personName"></span></b><script>$("#personName").html(localStorage.getItem("person_name"));</script></a>
                <li>
	 ...
	 <ul>
	     <li id="dock_item1">
             <a id="eins" class='osx-tooltip' href="#eins" data-text="Kontaktinfo">
                 <span class="bluePoint deaktiviert"><img src="images/finder.png" alt="Kontaktinfo" /></span>
             </a>
         </li>
         <li id="dock_item2">
             <a id="zwei" class='osx-tooltip' href="#zwei" data-text="Stundeplan">
                 <span class="bluePoint deaktiviert"><img src="images/calendar.png" alt="Stundeplan" /></span>
             </a>
         </li>
         <li id="dock_item3">
             <a id="drei" class='osx-tooltip' href="#drei" data-text="Lehrerliste">
                 <span class="bluePoint deaktiviert"><img src="images/contacts.png" alt="Lehrerliste" /></span>
             </a>
         </li>
	 </ul>
 </div>
...
position: absolute;
                                   margin-top: 5px;
                                   ">&nbsp;</span>&nbsp;&nbsp;&nbsp;= % des vergangenen Schuljahres
                             <br>
                             <span style="background-color: rgba(255, 255, 255, .8);
height: 7px;
width: 6px;
...
<div class="errorEasterEgg" style="display: none">
    ...
    <div class="errorEasterEgg_message">
        <img alt="error" src="errorEasterEgg.png" />
...
<div class="window contactInfo" id="item1">
 ...
 <div class="window" id="readMeInfoDiv" style="visibility: visible">
  ...
  <div class="body" style=" overflow-y: scroll; position:relative;top: -18px; height:94%; width: 98.4%;">
    <center><h2>VDesktop</h2>
        <img src="preview_pic.jpg" alt="preview" style="height:50%;" />
        <br>
      ...
      <br>
      Das Ziel war, Schülern sowie Lehrern mit kleinen n&auml;tzlichen Tools zu unterst&auml;zen, die schnell und einfach f&uuml;r beide zu bedienen sind.
    </center>
  </div>
</div>
...
border-color: #EBE9C5;
background: #FDFDEF url(images/alert_warning.png) no-repeat 20px 1.6em;
}
        </style>
  ...
  <div class="desktop">
    <div class="deskIcon" style="left: 1279px; top: 121px;">
          <img src="images/textedit.png" id="readmeRightClick" oncontextmenu="javascript:readMeRightClick()" ondblclick="zeigeUeberDiesesProejkt()" alt="readme.txt" />
